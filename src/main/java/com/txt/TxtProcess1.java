...
/*		String inFile = "D:/tmp/test.txt";
		...
		String inFile = "D:/tmp/complain_201311_201312.txt";
		String outFile ="D:/tmp/complain_201311_201312_out.txt";
		try {
	...
	public static void processFile(String inFileName,String outFileName) 
	 throws FileNotFoundException,IOException{
		...
		do {
			...
			if (null != lineStr) {
				line++;
//				System.out.println(new String(lineStr.getBytes("ANSI"), "UTF-8"));
